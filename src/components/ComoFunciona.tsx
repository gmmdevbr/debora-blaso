...
const steps = [
  {
    ...
    description: 'Atendimento Online (Global) ou Presencial em Belo Horizonte/MG.',
  },
  {
    number: '02',
    title: 'Agende sua Sessão',
    description: 'Entre em contato pelo WhatsApp para verificar disponibilidade.',
  },
  {
    number: '03',
    title: 'Seu Ritmo',
    description: 'Definimos a frequência e o plano terapêutico ideal para sua necessidade.',
  },
];

export function ComoFunciona() {
  return (
    <section id="como-funciona" className="py-32 px-6 md:px-12 bg-summer-sand scroll-mt-20">
      <div className="max-w-7xl mx-auto">
        <div className="mb-20 reveal">
          <span className="text-[10px] uppercase tracking-[0.25em] font-bold text-walnut block mb-4">
            Passo a Passo
          </span>
          <h2 className="font-display text-5xl lg:text-7xl text-monstera">Como funciona?</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            ...
            >
              ...
              <h3 className="font-display text-2xl text-monstera mb-4">{step.title}</h3>
        ...
        <div className="mt-16 p-6 bg-walnut/10 rounded-2xl border border-walnut/20 flex gap-4 items-start max-w-2xl mx-auto reveal">
          ...
          <div>
            ...
            <p className="text-sm text-monstera/80 leading-relaxed">
              Atendimentos particulares. Não aceitamos convênios diretamente, mas fornecemos recibo
