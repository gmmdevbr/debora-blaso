...
import { Eye, Fingerprint, Hourglass, Sprout, Plus } from 'lucide-react';
...
const cards: CardData[] = [
  {
    ...
    backText: 'Dificuldade de reconhecer qualidades, sensação de inadequação constante.',
  },
  {
    icon: Fingerprint,
    title: 'Expressão de Identidade',
    backTitle: 'Identidade',
    backText: 'Relação conflituosa com o espelho. Quando a roupa atua como barreira.',
  },
  {
    icon: Hourglass,
    title: 'Futuro & Planejamento',
    backTitle: 'Futuro',
    backText: 'Organização das finanças e da aposentadoria com segurança emocional.',
  },
  {
    icon: Sprout,
...
export function Motivos() {
  return (
    <section id="motivos" className="py-32 px-6 md:px-12 bg-monstera text-summer-sand scroll-mt-20">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20 reveal">
          <h2 className="font-display text-4xl lg:text-6xl tracking-tighter mb-6 leading-tight">
            ...
            para fazer terapia.{' '}
            <span className="text-ginkgo italic font-script">Qual é o seu?</span>
          </h2>
